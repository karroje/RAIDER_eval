...
def create_target(seq_file):
    """from seq_file and rm_file create an .fa file of repeat sequences in out_file"""
    assert seq_file.endswith(".fa")
    rm_file = seq_file + ".out"
    out_file = seq_file.rstrip(".fa") + ".rptseq.fa"
...
if __name__ == "__main__":
    for file in sys.argv[1:]:
        ...
        output_file = create_target(file)
        createDatabase(output_file, False)
